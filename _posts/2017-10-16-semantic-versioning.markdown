...
Surely the addition of `9 + 3` is ***12*** and not **27**! It seems like we have a bug here! Looking at
this line: `this.add = function(x, y) { return this.x * this.y }`, we have used the wrong operator. Let's fix this bug by making this change (i.e replacing * with +):
